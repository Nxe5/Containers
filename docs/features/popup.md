...
- **Toggles** — "Auto isolate all unmatched tabs" (`isolateUnmatched`), "Replace tab
  ...
  [rule-resolution.md](../architecture/rule-resolution.md#keep-links-in-their-origin-container-stickycontainers)),
  and "Keep sign-in flows where they start" (`preserveAuthFlows` — see
